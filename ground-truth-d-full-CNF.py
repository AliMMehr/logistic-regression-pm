...
happyAlone_given_S_A=tt.as_tensor_variable(np.random.rand(2,2)) #[[0.89,0.67],[0.47,0.18]]
...
# testing with the best params in d-model:
...
print('logloss of (d) with best params on the data:',logloss/len(y_test))
model_comparison['best param(d)']={'logloss':logloss/len(y_test)}
...
final_comparison_results={'ground truth':'D',
...
with open('./results/d_%d.json'%(run_id),'w') as f:
