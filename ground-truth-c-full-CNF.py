...
happyAlone_gt=np.random.rand(1)[0]#0.6

haveSiblingT_given_happyAloneT_gt=np.random.rand(1)[0]#0.3
haveSiblingT_given_happyAloneF_gt=np.random.rand(1)[0]#0.8

AnxietyT_given_happyAloneT_gt=np.random.rand(1)[0]#0.2
AnxietyT_given_happyAloneF_gt=np.random.rand(1)[0]#0.5
...
with basic_model:
    happyAlone=pm.Bernoulli('happyAlone',happyAlone_gt)
    
    haveSibling_p=pm.Deterministic('haveSibling_p',pm.math.switch(happyAlone, haveSiblingT_given_happyAloneT_gt, haveSiblingT_given_happyAloneF_gt))
    haveSibling=pm.Bernoulli('haveSibling',haveSibling_p)
    
    Anxiety_p=pm.Deterministic('Anxiety_p',pm.math.switch(happyAlone, AnxietyT_given_happyAloneT_gt, AnxietyT_given_happyAloneF_gt))
    Anxiety=pm.Bernoulli('Anxiety',Anxiety_p)
...
# # Test on best model (C)

# In[25]:


# Test on best model (C)
shared_p_happyAlone=happyAlone_gt
shared_p_haveSiblingT_given_happyAloneT=haveSiblingT_given_happyAloneT_gt
shared_p_haveSiblingT_given_happyAloneF=haveSiblingT_given_happyAloneF_gt
...
shared_p_AnxietyT_given_happyAloneT=AnxietyT_given_happyAloneT_gt
shared_p_AnxietyT_given_happyAloneF=AnxietyT_given_happyAloneF_gt
...
print('logloss of (c) best param on the data:',logloss/len(y_test))
model_comparison['(c) best param']={'logloss':logloss/len(y_test)}
...
final_comparison_results={'ground truth':'C',
                          'ground truth probabilities':{
                                'happyAlone_gt':happyAlone_gt,

                                'haveSiblingT_given_happyAloneT_gt':haveSiblingT_given_happyAloneT_gt,
                                'haveSiblingT_given_happyAloneF_gt':haveSiblingT_given_happyAloneF_gt,

                                'AnxietyT_given_happyAloneT_gt':AnxietyT_given_happyAloneT_gt,
                                'AnxietyT_given_happyAloneF_gt':AnxietyT_given_happyAloneF_gt,

                                'ObsHaveSibling_given_HaveSiblingT_gt':ObsHaveSibling_given_HaveSiblingT_gt.tolist(),
                                'ObsHaveSibling_given_HaveSiblingF_gt':ObsHaveSibling_given_HaveSiblingF_gt.tolist(),

                                'ObsAnxiety_given_AnxietyT_gt':ObsAnxiety_given_AnxietyT_gt.tolist(),
                                'ObsAnxiety_given_AnxietyF_gt':ObsAnxiety_given_AnxietyF_gt.tolist(),
                          },
                          'model_loglosses':{},
                         }
...
with open('./results/c_%d.json'%(run_id),'w') as f:
